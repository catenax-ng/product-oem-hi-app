...
@NamedNativeQuery(name = "HealthIndicatorsDAO.insert",
        query = "INSERT INTO healthindicators (id, vehicle_id, calculation_timestamp, calculation_sync_counter, values) "
                + "VALUES (:id, :vehicle_id, :calculation_timestamp, :calculation_sync_counter, :values)")
